label ch0_main:
	...
	"Most of the lesson today was review,and even the new bits were pretty unimportant."
	"I look out to the window and idle as the wind kicks up a few branches."
    mc "Clubs..."
    "Sayori wants me to check out some clubs."
	"I'm a bit on the fence about it."
	"Although it would be a pretty great way for me to socialize a bit,"
	"The thought of dogpiling the responsibilities I already associate with school with a club seems a bit..."
	"...what's the word..."
	"...{i}'excessive'{/i} for a nerd like myself."
	"I know,kinda pathetic,right?"
	"I can barely fit together my relationship with Sayori."
	"She's a fairly well kept together person,balancing her work in her classes as a normal student on top of her work in her club."
	"Sayori,if I can remember correctly,has been a member for at least two weeks now."
	"She's so well-made and up-to-speed on certain things I can't even manage to grasp,"
	"That it's either no wonder or quite strange that she's so often late to class."
	"In any case,I still proclaim it a wonder that Sayori fell into the sphere of influence of someone like me."
	"I guess it had to do with our parents being coworkers at some point."
	"It must've been when we were at least kintergardeners,as I don't remember playing with a few of the toys I grew out of then when Sayori came to visit."
	"Sayori's parents couldn't afford a babysitter,so they'd just have Sayori dropped off at our place to visit."
	"Details about it flutter as soon as they come to me,so I can't tell you much of the details."
	"I can tell you though that our most frequently played game was Tag."
	"The house wasn't a very safe place to play Tag honestly."
	"Our mom was into collecting expensive china and had them frequently on display in the kitchen."
	"Thankfully,it was behind a glass door by the time I was six,"
	"But can you imagine having expensive china out in the open while two rowdy children were playing Tag?"
	"For well over a year at that?"
	"Some of the things our parents did back then was kinda bizarre now that I look back on it."
	"Like how Sayori's dad frequently just let us play on the playground unattented while he went to smoke just a bit outside the park."
	"Or how my Mom at one point had us sit outside in the rain for a bit when we misbehaved."
	"..."
	"Come to think of it..."
	"My parent's punishments were weird."
	"They weren't strict,just absolutely obscure."
	"One time,my mom caught me scribbling on the wall and so then started drawing all over my favorite toy in revenge."
	"I didn't complain though,as she was actually pretty good at drawing so all it did was make the toy look cooler."
	"Maybe her idea of punishment was in an 'eye for an eye' fashion,but some of them got absurd."
	"I had to once brush every window in the house with a toothbrush when I was seven."
	"Back then,I assumed I'd die before I finished because of how outlandish the idea sounded."
	"But my dad talked with Mom after I was halfway through with finishing the second window in the house and it'd already been an hour."
    ...
    "I probably should've mentioned while I was giving my bit on Sayori that she's the vice president of the Literature Club."
