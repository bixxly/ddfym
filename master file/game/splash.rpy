...
init python:
    ...
    splash_message_default = "This mod is unaffiliated with Team Salvato."
    #Optional splash messages, originally chosen at random in Act 2 and Act 3
    splash_messages = [
    "This gon be good"
	"Please record your reaction thanks"
	"this game is 50x better with facecam"
    "haha dicks lol"
	"Sorry."
    ]
...
image menu_logo:
    "/mod_assets/images/underconstruction.png"
    subpixel True
    xcenter 240
    ycenter 120
    zoom 0.60
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "[config.name] is not affiliated with Team Salvato."
        "[config.name] assumes you've already played vanilla DDLC and have played past the space classroom."
		"Are you willing to view scenes that may or may not include explicit nudity?This especially applies if you're streaming this game."
			"Yes":
				pass
			"No":
				$ nonudity = "1" #this game's gon be gud
        "By playing [config.name],you agree that you are at least 18 years of age,and agree that this game has no affiliation with Team Salvato."
            "I agree.":
                pass
			"I don't agree.":
				$ renpy.quit()
...
label after_load:
    ...
    if anticheat != persistent.anticheat:
        ...
        "Ummm..."
		"Hey..."
		"I know this game can be boring at times..."
		"Especially with the fact that the extended version is long and all..."
		"But you really shouldn't cheat."
		"So..."
		"Sorry,but..."
		{cps=30}...I have to do this-{/cps}{nw}
        #Handle however you want, default is to force reset all save data
		#made it so that it also quits the game afterwards
        $ renpy.utter_restart()
		$ renpy.quit()
    return
