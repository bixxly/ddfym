...
Breathing human eyes. Breathing time. Breathing prayer. Breathing sky. Breathing wheel."""
    ...
    poem_y23 = Poem(
        ...
        title = "mdpnfbo,jrfp",
        text = """\
Quid, qui hoc petit?Et evaginatum tenentem gladium,per manum cor tuum,et cor\
 tuum in te?Quid sanguis in manibus dimisit?Quia libido?Ille fremit et saturata est\
 anima.Quid animal feres?Quid animal passus est ipse?Non enim pertinet?Facturum\
 se lugere?Videtur quod non.Ĉi tiu sango estas sur liaj manoj.Li lasis ĝin trempi.Li\
 sentis euphorion.Li sentis ekstere.Li sentis viva.La momenton,kiun li nun gajnis\
 en sia vivo,fariĝis tio,kion li timis,kiam li estis akompanata de fervoro de volupto.\
 Lia koro kuris.Lia vizaĝo estis ruĝa.Ne nur makulita de la sango de sia amanto,\ 
 sed laŭ la absoluta naturo de sia deziro.Ĉi tiu vivo de lia.Ĉi tiu morto de ŝia.\
 Minutna dłoń dotknęła ręki i przebiła ją, pozwalając,by krew spłynęła na\ 
 podłogę.Dzwon.Pierścień.Miłość.Nie problem.Żadne problemy naprawdę nie miały\ 
 znaczenia.Jego chwila ekstazy i pożądania szybko nastąpiła po intensywnym bólu w\ 
 klatce piersiowej.Gorączkowa sprawa jego gorączkowej natury.Bo to, co nastąpiło,jest\ 
 uroczo niezauważone.\
